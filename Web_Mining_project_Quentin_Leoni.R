...
write.csv(data_f, file="dataset_France.csv", row.names = FALSE)

################################################################################
# OR import csv for results replicability
# data_f <- read.csv('dataset_France.csv')
...
# save extracted data to csv
write.csv(data_d, file="dataset_Germany.csv", row.names = FALSE)

################################################################################
# OR import csv for results replicability
# data_d <- read.csv('dataset_Germany.csv')
